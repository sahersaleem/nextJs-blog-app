...
const TestimonialCarosual = () => {
  return (
    <div>
      <Carousel className="xs:w-[200px] lg:w-[300px] ">
        <CarouselContent className="">

          {testimonials.map((item)=>(
            <CarouselItem key={item.name} className="">
            <div className="border-[#163020] border-[3px] rounded-md p-6 xs:h-[400px] lg:h-auto ">
              <Image src={item.profileImage}  width={100} height={100} alt="testimanila" className="w-[100px] h-[100px] object-cover object-center rounded-full border-[3px] border-[#163020]"/>
